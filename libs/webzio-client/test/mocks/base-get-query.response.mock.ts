...
export function baseGetQueryResponseMock(
  ...
  return {
    ...
    next: '/newsApiLite?token=any-token-here&ts=1751379763514&q=title%3AWeb+Development&sort=relevancy&order=desc&from=10&ns=22.511053&ni=4a75ba02fabea63a0f82e3ecc338f4bce54053c8&highlight=true&size=10',
    requestsLeft: 943,
  };
}
